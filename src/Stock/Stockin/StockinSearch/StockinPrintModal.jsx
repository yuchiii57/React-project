...
import StockinPrintForm from "./StockinPrintForm";
...
export default props => {
  ...
  //const stockinData = data.stocks;
  // console.log("soDetails data", soDetailData);
  ...
  return (
    ...
    >
      ...
      <Modal.Content>
        <StockinPrintForm printId={props.printId} />
