...
import StockoutPrintModal from "./StockoutPrintModal";
...
export default props => {
  ...
  return (
    <div align="center">
      {appState.isLevel02Clicked === true &&
        <div>
          <h3 align="center" >出庫明細</h3>
          <h3 align="center" >出庫單號:{appState.stockId} - 出庫原因:{appState.purpose}</h3>
          <br />
          <table border="1">
                ...
                return (
                  <tr key={stock.ID}>
                    ...
                    <td>
                      ...
                      >
                        <StockoutPrintModal printId={stock.ID} purpose={appState.purpose} stockId={stock.stockId} />
                      </button>
                    </td>
                  </tr>
                );
