...
import "./Stock.css";
import BarcodeStockout from "../../API/BarcodeStockout";
...
export default () => {
  ...
  const stockId = useSelector(state => state.stockoutId);
  ...
  const { data, loading, error } = useQuery(stockQ, {
    variables: { stockId: stockId, type: "出庫" },
    pollInterval: 500
  });
  ...
  return (
    <div align="center">
      <h3 align="center" >出庫明細</h3>
      <h3 align="center" >出庫單號:{stockId} - 出庫原因:{purpose} ** 建檔員工: {userName} ** {createDT}</h3>
      <BarcodeStockout stockId={stockId} />
      <br />
      <table border="1">
